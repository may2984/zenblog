<x-layout>  
    ...
    <script>
      ...
      Dropzone.options.profilePhoto = {
        
        paramName: "profile_photo", // The name that will be used to transfer the file
        acceptedFiles: '.jpg',
        ...
        maxFilesize: 4,
        //clickable: '#upload_profile_photo',
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              <img src="{{ asset('admin/'.env('ADMIN_PROFILE_PHOTO_DIR').'/'.$thumb_image) }}" alt="{{ $user->name }}" class="card">
           
              <h2>{{ $user->name }}</h2>
              <h3>{{ $user->role }}</h3>
              <div class="social-links mt-2">
                <a href="{{ $user->twitter }}" class="twitter" target="_blank"><i class="bi bi-twitter"></i></a>
          ...
          <!--form action="{{ route('profile.photo.upload') }}" class="dropzone" id="profile-photo">
            @csrf               
         </form-->
        </div>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">{{ $user->about ? $user->about : 'NA' }}</p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $user->company ? $user->company : 'NA' }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Role</div>
                    <div class="col-lg-9 col-md-8">{{ $user->role ? $user->role : 'NA' }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Country</div>
                    <div class="col-lg-9 col-md-8">{{ $user->country ? $user->country : 'NA' }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Address</div>
                    <div class="col-lg-9 col-md-8">{{ $user->address ? $user->address : 'NA' }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">{{ $user->phone ? $user->phone : 'NA' }}</div>
                  </div>
                  ...
                  <form action="{{ route('admin.profile.save') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="{{ asset('admin/'.env('ADMIN_PROFILE_PHOTO_DIR').'/'.$thumb_image) }}" alt="Profile">
                        <div class="pt-2">
                          <div class="input-group">
                            <input type="file" class="form-control" id="profile_photo" name="profile_photo" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                          </div>
                          <!--a data-bs-toggle="modal" data-bs-target="#fullscreenModal" href="#" class="btn btn-primary btn-sm" title="Upload new profile image">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select class="form-select" aria-label="Default select example" name="country">
                          <option selected>{{ $user->country != 'Select Country' ? $user->country : 'Select Country' }}</option>
