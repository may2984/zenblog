  ...
  <script>
      $(function(){
        ...
        dropzone.on("complete", function(file) {
          ...
          $('#banner_image').val(file.xhr.responseText);
          
          var banner_image = file.xhr.responseText;

          alert(banner_image);

          $("#bannerModal").modal('show', function(){

           
            
            alert(banner_image);

            var banner_image = '/banners/bq00dMwkckTzjxtxXoSYuW3So4yAK9TjYfuocI7Y.jpg';
...
<section>
  <div id="dropzone">
    <form class="dropzone needsclick" id="demo-upload" action="{{ route('banner.upload') }}">
      @csrf
      <div class="dz-message needsclick"><i class="bi bi-upload"><br>Choose / Drag and drop a file</i></div>
    </form>
  </div>
</section>
